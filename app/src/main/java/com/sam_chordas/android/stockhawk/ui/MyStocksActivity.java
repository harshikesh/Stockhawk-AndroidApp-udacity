...
import com.sam_chordas.android.stockhawk.utitlity.Util;
...
public class MyStocksActivity extends AppCompatActivity
  ...
  private RelativeLayout mNoStockLayout;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mNoStockLayout = (RelativeLayout) findViewById(R.id.noStockLayout);
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
        new RecyclerViewItemClickListener.OnItemClickListener() {
          @Override public void onItemClick(View v, int position) {
            ...
            intent.putExtra(StockDetailActivity.STOCK_SYMBOL, symbol);
            intent.putExtra(StockDetailActivity.STOCK_PRICE, price);
            intent.putExtra(StockDetailActivity.STOCK_CHANGE, change);
              ...
              .input(R.string.input_hint, R.string.input_prefill,
                  new MaterialDialog.InputCallback() {
                    @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                      ...
                      if (c.getCount() != 0) {
                        Toast toast =
                            Toast.makeText(MyStocksActivity.this, R.string.already_in_stock,
                                Toast.LENGTH_LONG);
  ...
  public void dataLayoutChange() {
    if (Util.isNetworkConnected(getApplicationContext())) {
      if (mCursorAdapter.getItemCount() == 0) {
        mNoStockLayout.setVisibility(View.VISIBLE);
      } else {
        mNoStockLayout.setVisibility(View.GONE);
      }
    } else {
      if (mCursorAdapter.getItemCount() == 0) {
        mNoStockLayout.setVisibility(View.VISIBLE);
  ...
  public void networkToast() {
    Snackbar.make(mNoStockLayout, getString(R.string.network_toast), Snackbar.LENGTH_LONG).show();
  }
